...
namespace KitapEvi.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult SummaryPost(string stripeToken)
        {
            ...
            _unitOfWork.Save();
            HttpContext.Session.SetInt32(SharedDetail.ssShoppingCart, 0);

            if (stripeToken == null)
            {
                //order will be created for delayed payment for authroized company
                ShoppingCartVM.OrderHeader.PaymentDueDate = DateTime.Now.AddDays(30);
                ShoppingCartVM.OrderHeader.PaymentStatus = SharedDetail.PaymentStatusDelayedPayment;
                ShoppingCartVM.OrderHeader.OrderStatus = SharedDetail.StatusApproved;
            }
            else
            {
                //process the payment
                ...
                {
                    ShoppingCartVM.OrderHeader.PaymentStatus = SharedDetail.PaymentStatusApproved;
                    ShoppingCartVM.OrderHeader.OrderStatus = SharedDetail.StatusApproved;
